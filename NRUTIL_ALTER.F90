MODULE nrutil
	...
	END INTERFACE
	INTERFACE swap
		MODULE PROCEDURE swap_i,swap_r,swap_rd,swap_rv,swap_dv,swap_c, &
	...
	END INTERFACE
	INTERFACE imaxloc
		MODULE PROCEDURE imaxloc_r,imaxloc_i,imaxloc_rd
	END INTERFACE
	INTERFACE iminloc
		MODULE PROCEDURE iminloc_r,iminloc_rd
	END INTERFACE
	INTERFACE assert
...
!BL
	FUNCTION imaxloc_rd(arr)
	REAL(DP), DIMENSION(:), INTENT(IN) :: arr
	INTEGER(I4B) :: imaxloc_rd
	INTEGER(I4B), DIMENSION(1) :: imax
	imax=maxloc(arr(:))
	imaxloc_rd=imax(1)
	END FUNCTION imaxloc_rd
!BL
...
!BL
	FUNCTION iminloc_rd(arr)
	REAL(DP), DIMENSION(:), INTENT(IN) :: arr
	INTEGER(I4B), DIMENSION(1) :: imin
	INTEGER(I4B) :: iminloc_rd
	imin=minloc(arr(:))
	iminloc_rd=imin(1)
	END FUNCTION iminloc_rd
!BL
